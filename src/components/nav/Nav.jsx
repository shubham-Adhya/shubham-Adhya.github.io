  ...
  return (
    <nav id="nav-menu">
      ...
      <DarkTooltip title="Download Resume" placement='top'>
        <a target='_blank' href={Shubham_Adhya_Resume} download='Shubham_Adhya_Resume.pdf' onClick={onClickhandler} rel='noreferrer' className='nav-link resume' id="resume-link-1">
          <GoDesktopDownload/>
        </a>
      </DarkTooltip>
